...
invertedIndex = get_inverted_index("stem_inverted_index.json")
docLens = get_document_length("stem_doc_length")
Queries = get_cacm_queries("cacm_stem.query.txt")
...
resultFile = open("tfidf_stem.txt", "w")
